...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.ViewHolder> {
    ...
    public OrdersAdapter(Context context, List<OrdersModel.Deliverdetails> ordersModel) {
    ...
    public OrdersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.vendororder_items,parent, false);
    ...
    public void onBindViewHolder(@NonNull OrdersAdapter.ViewHolder holder, int position) {
        ...
        holder.approve_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                apiInterface.approveorder(requestBody).enqueue(new Callback<RequestOrderResponse>() {
                    @Override
                    public void onResponse(Call<RequestOrderResponse> call, Response<RequestOrderResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (response.body().getStatus().equals("1")) {
                                ...
                                holder.approve_btn.setText("Approved");
