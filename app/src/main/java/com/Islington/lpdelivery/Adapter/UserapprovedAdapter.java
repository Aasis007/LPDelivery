...
public class UserapprovedAdapter extends RecyclerView.Adapter<UserapprovedAdapter.ViewHolder> {
    ...
    public UserapprovedAdapter(Context context, List<OrdersModel.Deliverdetails> ordersModel) {
    ...
    @NonNull
    @Override
    public UserapprovedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.approvedordersusers_activity,parent, false);
        return new ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull UserapprovedAdapter.ViewHolder holder, int position) {
